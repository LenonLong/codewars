...
the time has come to code a solution for finding The Loch Ness Monster. Note that the phrase can also be written as "3.50" or "three fifty". 
Your function should return true if you're talking with The Loch Ness Moster, false otherwise.
*/
function isLockNessMonster(s) {
  const caseWord = s.toLowerCase();

  return caseWord.includes('tree fiddy') || caseWord.includes('$3.50') || caseWord.includes('three fifty');
}
  
  console.log(isLockNessMonster("Your girlscout cookies are ready to ship. Your total comes to tree fiddy")); // true
  console.log(isLockNessMonster("Howdy Pardner. Name's Pete Lexington. I reckon you're the kinda stiff who carries about tree fiddy?")); // Output: true
  console.log(isLockNessMonster("I'm from Scotland. I moved here to be with my family, sir. Please, $3.50 would go a long way to help me find them.")); // Output: true
